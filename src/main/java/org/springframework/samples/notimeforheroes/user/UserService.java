...
public class UserService {
	...
	public User getLoggedUser() {
		org.springframework.security.core.userdetails.User user_aux = (org.springframework.security.core.userdetails.User) SecurityContextHolder
	...
	public Map<User, Integer> getListOfOpponents(User user) {
		...
		players.entrySet().stream().sorted(Map.Entry.<User, Integer>comparingByValue().reversed());
